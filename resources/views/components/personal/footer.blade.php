        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            <div>
                <div class="flex items-center space-x-2 mb-4">
                    {{-- Logo Icon --}}
                    <x-app-logo-icon class="w-8 h-8 text-purple-600" />
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    {{-- FIXED: Added route('home') so these work from the Dashboard --}}
                    <li><a href="{{ route('home') }}#features" class="text-gray-400 hover:text-white transition">Features</a></li>
                    <li><a href="{{ route('home') }}#pricing" class="text-gray-400 hover:text-white transition">Pricing</a></li>
